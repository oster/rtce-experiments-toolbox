...
def write_Kandel_Moles_all_revisions(file, num, experiment_name):
	...
	for rev in selected_revs:
		...
		scores.append(get_revision_Kandel_Moles(rev))
		i=i+1
...
OUTPUT_DATA_FILE='./DATA-results/KandelMoles.csv'
...
with open(OUTPUT_DATA_FILE, "w") as w:	
	...
	#for group in ['019']:
		...
		write_Kandel_Moles_all_revisions(w, num, experiment)
